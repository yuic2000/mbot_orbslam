...
*/
void draw_robot(const mbot_lcm_msgs::pose2D_t& pose, const float color[4],const float body_color[4], vx_buffer_t* buffer);
...
*/
void draw_laser_scan(const mbot_lcm_msgs::lidar_t& laser,
                     const mbot_lcm_msgs::pose2D_t& pose,
                     const float color[4], vx_buffer_t* buffer);
...
*/
void draw_path(const mbot_lcm_msgs::path2D_t& path, const float color[4], vx_buffer_t* buffer);
