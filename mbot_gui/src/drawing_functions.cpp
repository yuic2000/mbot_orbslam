...
void draw_robot(const mbot_lcm_msgs::pose2D_t& pose, const float* color,  const float* body_color, vx_buffer_t* buffer)
{
...
void draw_laser_scan(const mbot_lcm_msgs::lidar_t& laser, const mbot_lcm_msgs::pose2D_t& pose, const float* color, vx_buffer_t* buffer)
{
...
void draw_particles(const mbot_lcm_msgs::particles_t& particles, vx_buffer_t* buffer)
{
    int total_points = particles.num_particles;
    float particle_plot[2 * total_points];
    std::vector<mbot_lcm_msgs::particle_t> temp;
...
void draw_path(const mbot_lcm_msgs::path2D_t& path, const float* color, vx_buffer_t* buffer)
{
    ////////////////// TODO: Draw path2D_t as specified in assignment ////////////////////////////
